...
class RobotSerial:
    ...
    def get_busy(self, nb):
        ...
        for _ in range(nb):
            ...
            if abs(perr_1) < constant.PERROR and abs(perr_2) < constant.PERROR and abs(self.get_speed(1)) < constant.SPEED_BUSY and abs(self.get_speed(2)) < constant.SPEED_BUSY:
                counter += 1
